 ...
 * @method static void markPackageInstalled(string $name, ?string $actor = null)
 * @method static void markPackageProviderQuarantined(string $name, string $provider, string $reason)
