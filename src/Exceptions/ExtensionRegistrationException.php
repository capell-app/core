...
class ExtensionRegistrationException extends RuntimeException
{
    public function __construct(
        ...
        string $docUrl = 'https://github.com/capell-app/capell/blob/1.x/docs/extending-capell.md',
    ...
    public static function forPageType(string $class, ?Throwable $previous = null): self
    {
        return new self(
            $class,
            PageTypeData::class,
            'https://github.com/capell-app/capell/blob/1.x/docs/extending-capell.md#page-types',
            $previous,
        );
    }
    ...
    public static function forSchema(string $class, ?Throwable $previous = null): self
    {
        return new self(
            ...
            'https://github.com/capell-app/capell/blob/1.x/docs/extending-capell.md#schemas',
            $previous,
        );
    }
    ...
    public static function forWidget(string $class, ?Throwable $previous = null): self
    {
        return new self(
            ...
            'https://github.com/capell-app/capell/blob/1.x/docs/extending-capell.md#widgets',
            $previous,
        );
    }
}
