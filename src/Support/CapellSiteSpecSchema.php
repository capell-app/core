...
final class CapellSiteSpecSchema
{
    ...
    public static function toArray(): array
    {
        ...
        $remoteImageUrl = ['type' => ['string', 'null'], 'format' => 'uri', 'maxLength' => CapellSiteSpecConstraints::MAX_REMOTE_URL_LENGTH];
        ...
        return [
            ...
            'properties' => [
                ...
                'site' => ['type' => 'object', 'required' => ['name'], 'additionalProperties' => false, 'properties' => [
                    'name' => ['type' => 'string', 'minLength' => 1], 'businessName' => $nullableString,
                    'organisationType' => $nullableString, 'description' => $nullableString,
                ]],
                'theme' => ['type' => 'object', 'required' => ['key'], 'additionalProperties' => false, 'properties' => [
                    'key' => ['type' => 'string', 'minLength' => 1],
                    'colors' => ['type' => 'object', 'additionalProperties' => false, 'properties' => ['primary' => $colour, 'secondary' => $colour, 'accent' => $colour]],
                    'fontFamily' => $nullableString, 'linkColor' => $colour, 'linkColorActive' => $colour,
                ...
                'pages' => ['type' => 'array', 'minItems' => CapellSiteSpecConstraints::MIN_PAGES, 'maxItems' => CapellSiteSpecConstraints::MAX_PAGES, 'items' => [
                    'type' => 'object', 'required' => ['name', 'slug', 'title', 'pageType'], 'additionalProperties' => false, 'properties' => [
                        ...
                        'sections' => ['type' => 'array', 'items' => ['type' => 'object', 'required' => ['type', 'content'], 'additionalProperties' => false, 'properties' => [
                ...
                'navigations' => [
                    'type' => 'array',
                    'maxItems' => CapellSiteSpecConstraints::MAX_NAVIGATIONS,
                    'items' => [
                        'type' => 'object',
                        'required' => ['key', 'pageSlugs'],
                        'additionalProperties' => false,
                        'properties' => [
                            'key' => ['type' => 'string', 'pattern' => CapellSiteSpecConstraints::SLUG_PATTERN],
                            'name' => $nullableString,
                            'pageSlugs' => [
                                'type' => 'array',
                                'uniqueItems' => true,
                                'items' => ['type' => 'string', 'pattern' => CapellSiteSpecConstraints::SLUG_PATTERN],
                            ],
                        ],
                    ],
                ],
                'media' => [
                    ...
                    'properties' => [
                        ...
                        'images' => [
                            'type' => 'object',
                            'maxProperties' => CapellSiteSpecConstraints::MAX_MEDIA_IMAGES,
                            'propertyNames' => ['pattern' => CapellSiteSpecConstraints::SLUG_PATTERN],
                            'additionalProperties' => ['type' => 'string', 'format' => 'uri', 'maxLength' => CapellSiteSpecConstraints::MAX_REMOTE_URL_LENGTH],
                        ],
                    ],
                ],
                'extensions' => [
                    'type' => 'array',
                    'maxItems' => CapellSiteSpecConstraints::MAX_EXTENSIONS,
                    'uniqueItems' => true,
