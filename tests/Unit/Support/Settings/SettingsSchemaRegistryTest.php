...
test('registers a schema for a group', function (): void {
...
test('retrieves all schemas for a group', function (): void {
    $registry = new SettingsSchemaRegistry;
...
test('gets a specific schema by group and key', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class, 'admin');
...
test('returns null for non-existent schema key', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class, 'admin');
...
test('replaces a schema in a group', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class, 'admin');
...
test('throws when replacing non-existent schema key', function (): void {
    $registry = new SettingsSchemaRegistry;
...
test('removes a schema from a group', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class, 'admin');
...
test('removes group when last schema is removed', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class, 'admin');
    $registry->remove('admin', 'admin');
...
test('registers settings class for a group', function (): void {
    $registry = new SettingsSchemaRegistry;
...
test('registers settings class schema when exposed by the settings class', function (): void {
    $registry = new SettingsSchemaRegistry;
...
test('throws when registering invalid settings class', function (): void {
    $registry = new SettingsSchemaRegistry;
...
test('throws when registering a settings class that does not implement the contract', function (): void {
    $registry = new SettingsSchemaRegistry;
...
test('throws when registering a settings class under the wrong group', function (): void {
    $registry = new SettingsSchemaRegistry;
...
test('throws when registering invalid schema class', function (): void {
    $registry = new SettingsSchemaRegistry;
    expect(fn () => $registry->register('admin', InvalidSchema::class))
        ->toThrow(InvalidArgumentException::class, 'must implement');
});

test('removes all schemas from a group', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class, 'admin');
    $registry->register('admin', MockAdminSchemaExtended::class, 'extended');
    $registry->registerSettingsClass('admin', MockAdminSettings::class);
...
test('returns all registered groups', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class);
...
test('returns all schemas across groups', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class, 'admin');
...
test('uses class basename as default key when not provided', function (): void {
    $registry = new SettingsSchemaRegistry;
    $registry->register('admin', MockAdminSchema::class);
...
test('allows multiple schemas per group', function (): void {
    $registry = new SettingsSchemaRegistry;
