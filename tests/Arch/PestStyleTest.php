...
it('uses it for named Pest test definitions', function (): void {
    $violations = [];

    foreach (pestStylePhpPaths() as $path) {
 ...
 * @return list<string>
 */
function pestStylePhpPaths(): array
{
    $root = dirname(__DIR__, 4);
    $paths = [];

    foreach ([$root . '/packages', $root . '/tests'] as $sourceRoot) {
